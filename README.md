...
This directory contains supplementary data and files for the article *"An accessible solution for paleocoordinate calculation"*:

* **validation_dataset_original.xlsx** – Complete test dataset used for study validation, including 30 fossil sites with present-day coordinates, globally distributed and spanning a wide range of geological ages.  
* **validation_data_paleocoordinates.xlsx** – Static benchmark output described in section *4.2. Reproducibility and Long-Term Stability* of the article. Contains paleocoordinate outputs of the test dataset generated by PACA (v1.0) for comparison.  
* **validation_references.pdf** – Detailed bibliography of the test dataset, referencing original sources.
* **SUPPLEMENTARY TABLE.pdf** – Detailed comparison between the software described in this repository with other apps.
* **user_guide.pdf** – Comprehensive step-by-step user guide for using Paleocoordinates Calculator.
